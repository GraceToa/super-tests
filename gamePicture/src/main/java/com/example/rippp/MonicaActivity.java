 ...
 */
public class MonicaActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aula.setBackgroundResource(R.drawable.animation_monica);
        //
    ...
    private void playMediaPlayer(){
        sonido = MediaPlayer.create(MonicaActivity.this, R.raw.zombiesound);
        sonido.start();
    }
