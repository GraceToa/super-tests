 ...
 */
public class UriActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aula.setBackgroundResource(R.drawable.animation_uri);
        //
    ...
    private void playMediaPlayer(){
        sonido = MediaPlayer.create(UriActivity.this, R.raw.zombiesound);
        sonido.start();
    }
