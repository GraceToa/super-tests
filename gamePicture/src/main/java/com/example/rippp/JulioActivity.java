 ...
 */
public class JulioActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aula.setBackgroundResource(R.drawable.animation_julio);
        //
    ...
    private void playMediaPlayer(){
        sonido = MediaPlayer.create(JulioActivity.this,R.raw.zombiesound);
        sonido.start();
    }
